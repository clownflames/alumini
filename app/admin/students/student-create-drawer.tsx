...
const EMPTY: StudentCreateFormValues = {
  name: "",
  email: "",
  password: "",
};
...
export function StudentCreateDrawer({
  ...
  const [values, setValues] = useState<StudentCreateFormValues>(EMPTY);
  ...
  const set = <K extends keyof StudentCreateFormValues>(
    key: K,
    v: StudentCreateFormValues[K]
  ) => setValues((s) => ({ ...s, [key]: v }));
